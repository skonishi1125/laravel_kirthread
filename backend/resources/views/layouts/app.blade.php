...
<head>
  ...
  @if(Request::Is('game/rpg*'))
    ...
    <meta property="og:description" content="コマンド選択式のブラウザRPGゲームです。キャラクターの育成と物語をお楽しみください。">
...
<body>
  <div id="app">
    {{-- RPG スマホ画面のケースのヘッダーずれ対応 --}}
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm {{ Request::is('game/rpg*') ? 'is-rpg' : '' }}">
      <div class="container">
            ...
            @else
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="{{ route('guest_upgrade_get') }}">本登録</a>
