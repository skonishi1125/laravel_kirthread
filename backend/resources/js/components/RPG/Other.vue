    ...
    data() {
      return {
        manualItems: [
          ...
          {
            title: "バグ報告・ご要望について",
            content: "<p>バグや進行不能になった場合は、<a href='https://kir-thread.site/' target='_blank'>かあスレッド</a>メインページに書き込んでいただれば、<br>セーブデータを確認しエラーの原因究明及び、修正対応を行わせていただきます。<br><br>また感想や改善のご要望なども、今後の参考にさせて頂きますので是非ご投稿ください。</p>"
          },
          {
            title: "クレジット",
