  ...
  <div v-if="ending.status == 'loaded'">
    ...
    <div v-if="ending.view == 'ending_2'">
      <div class="row">
        ...
        <div class="col-12 my-5">
          <p style="font-style: italic;">Ending(2): 夢物語と共に</p>
        </div>
        <div class="col-12">
          <div class="answer-option-form">
        ...
        <div class="col-12" style="font-weight: bold; font-size: 0.95em;">
          <div style="background-color: #f5eff4; padding: 0px 20px; color: #4f4c4c;">
            ...
            <p>
              ...
              幸いにも我々には名声があり、そして人を助ける魔物の存在という揺るぎない証があった。<br>
              初めは半信半疑だった人々も我々の言葉に耳を傾け、やがて理解を示してくれた。
            </p>
            <p>
              伝承では人と魔物は相容れぬ存在として語られてきた。<br>
              我々は知っている。伝承そのものが誰かが編んだ物語に過ぎなかったのかもしれないということを。<br>
            </p>
            <p>
              ならば、人と魔物が戦いの末に手を取りあったという真の歴史をこの大陸に刻んでみせる。<br>
              それこそが我々が冒険の果てにこの地で見出した答えになる。
            </p>
            <p>
              もしも生きているうちにそんな世界が訪れたなら、彼らと肩を並べて未知なる大陸を共に旅してみたい。<br>
              理由は不要だろう。我々は英雄ではなく、冒険者なのだ。
            </p>
            <hr>
          </div>
        </div>
        <div class="col-12 my-5">
          <p style="font-weight: bold; color: #df71dd; font-style: italic;">Ending(true): 刻まれた伝承</p>
        </div>
        <div class="col-12">
          <div class="answer-option-form">
