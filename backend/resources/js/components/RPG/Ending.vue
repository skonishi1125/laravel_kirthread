  ...
  <div v-if="ending.status == 'loaded'">
        ...
        <div class="col-12" style="font-weight: bold; font-size: 0.95em;">
            <div style="padding: 0px 20px; background-color: #e1e8eb;">
                ...
                <p>
                  「なあ！」<br>
                  とある冒険者たちが声をかけてきた。<br>
                  「今回もあんたらなんだろ？ 沼地や暗闇の森だって、結局最初に踏破してギルドに情報を伝えたのはあんたらだったじゃないか。」
                </p>
                <hr>
            </div>
        </div>
      ...
      <div class="row">
        <div class="col-12" style="font-weight: bold; font-size: 0.95em;">
          <div style="padding: 0px 20px; background-color: #d5e3ff;">
            ...
            <p>
              要は、平和になったのだ。<br>
              話し合うことで、今の自分たちにできるのは人々の暮らしを守ることだと感じた。<br>
              その結果、この道を選ぶことになった。
            </p>
            <p>
              この選択が本当に正しかったのか、それを知る者はいない。<br>
              ...かつての英雄たちも富を得たとき、同じような考えで復興を目指したのだろうか。
            </p>
            <hr>
          </div>
        </div>
        <div class="col-12 my-5">
          <p style="font-style: italic;">エンド1: 人の世の復興</p>
        </div>
        <div class="col-12">
          <div class="answer-option-form">
        ...
        <div class="col-12" style="font-weight: bold; font-size: 0.95em;">
          <div style="padding: 0px 20px; background-color: #e1ebe1;">
            ...
            <p> 
              ...
              彼らとは本当に、争わなければ生きられぬ世界なのだろうか。その問い掛けは次第に頭から離れなくなっていった。
            </p>
            <p>
              我々は悩み抜いた末に、魔物との共存を模索する道を選択した。そのために富を使い手段を探り始めた。<br>
              調査は難航を極め、未だ目立った成果は得られていない。<br>
              街の人々も、せっかくの財産を魔物のために費やす我々を半ば呆れた目で見ているようにも見える。
            </p>
            <p>
              人と魔物は、あまりにも長く憎しみを重ねてきた。それは伝承からも読み取れる、紛れもない事実だ。<br>
              理屈ではなく、本能として分かり合えないのかもしれない。
            </p>
            <p>
              甘い考えだっただろうか。<br>
              ただ互いを恐れずにいられる世界があるかもしれないと考えたことは間違いだっただろうか。<br>
              ...かつての英雄たちは富を得たとき、この選択を夢物語と思い、選ばなかったのかもしれない。
            </p>
            <hr>
          </div>
        </div>
        <div class="col-12 my-5">
          <p style="font-style: italic;">エンド2: 共存を求めて</p>
        </div>
        <div class="col-12">
          <div class="answer-option-form">
    ...
    <div v-if="ending.view == 'ending_3'">
      <div class="row">
        ...
        <div class="col-12 my-5">
          <p style="font-weight: bold; color: #df71dd; font-style: italic;">エンド3: 刻まれた確かな伝承</p>
        </div>
        <div class="col-12">
          <div class="answer-option-form">
      ...
      <div class="row">
        <div class="col-12" style="font-weight: bold; font-size: 0.95em;">
          <div style="  background-color: #301717; padding: 0px 20px; color: #ff7c7c;">
            ...
            <p>
              伝承には、人と魔物が永劫に争い続けてきたと記されている。<br>
              だが、それが真実ではないことを我々は知っている。実際に、人を救う魔物が存在することもこの目で見たのだ。<br>
            </p>
            <p>
              しかし、いまさら誰にこの事実を伝えるというのか。<br>
              人々は我々を英雄と讃え、富と名声を惜しみなく捧げてくれる。それはあまりにも甘美で、心地が良い。<br>
              伝承の欺瞞を追求したあの人間も、恐らく既にこの世にはいないのだろう。もはや事実を知る者はいない。
            </p>
            <p>
              欺瞞を隠し通す道義心は、いつからか消え失せてしまった。<br>
              栄光の座に浸り続けることで得られる、底知れぬ快楽。我々は手放すことができなかった。
            </p>
            <hr>
          </div>
        </div>
        <div class="col-12 my-3">
          <p style="font-weight: bold; color:red; font-style: italic;">エンド4: 英雄の後継者</p>
        </div>
        <div class="col-12">
          <div class="answer-option-form">
