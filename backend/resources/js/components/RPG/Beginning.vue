...
.parameter-role.medic {
  clip-path: polygon(50% 20%, 90% 20%, 65% 58%, 65% 81%, 28% 92%, 30% 54%, 33% 36%);
}
...
<template>
    ...
    <div class="row">
      <div class="col-12" style="font-weight: bold; font-size: 0.95em;">
        <div style="padding: 0px 20px; background-color: #e1e8eb;">
          ...
          <p>
            かつて栄華を誇った王国があった。<br>
            国は人々の笑い声が絶えず、城下町は昼夜賑わいに包まれていた。<br>
            王国にそびえ立つ壮麗なる城は、その繁栄の象徴であった。<br>
          </p>
          <p>
            しかし時が流れ、いつからかその城は魔物の巣窟と化した。<br>
            かつての誇りは失われ、石壁は苔に覆われ、ついには凋落した城と成り果てた。<br>
          ...
          <p>
            ...
            当初は財宝を求めるために始まった騒動であったが、やがてその目的は多様な形を見せ始める。<br>
            魔物と戦い己の力を試す者、伝承の真実を探究する者。<br>
            また、人間と魔物が何故争うようになったのか。その答えを見出そうとする者もいた。<br>
          </p>
          <p>
            それぞれが己の信念を胸に、伝承の果てへと命を賭して挑む者たち。――彼らは、「冒険者」と呼ばれる。
          </p>
          <hr>
        </div>
      </div>
      <div class="col-12 my-3">
        <p>
          ...あなたも今まさに冒険者として旅立とうとしています。<br>
          信念を持つ仲間を募り、この世界の冒険へと向かいましょう。
        </p>
      </div>
      <div class="col-12">
  ...
  <div v-if="beginning.status == 'monologue'">
    <div class="row">
      <div class="col-12" style="font-weight: bold; font-size: 0.95em;">
        <div style="padding: 0px 20px; background-color: #e1e8eb;">
          ...
          <p>
            ...
            三人は互いの力を認め合い、いつしか同じ旅路を歩むことになった。
          </p>
          <p>
          ...
          <p>
            経験に乏しく、時に意見を違えることもあるだろう。<br>
            それでも、背を預け合うための静かな信頼が、やがて彼らの中に芽生えていくはずだ。
          </p>
          <p>
            三人はそれぞれの想いを携え、遥かなる伝承の地へと足を踏み出した。<br>
            その行く先に待つのは富か、真実か、あるいは己の力の果てか、もしくは理由そのものか。<br>
          </p>
          <p>
            彼らの旅路がどのような結末を迎えるのか。それを知る者は、まだいない。
          </p>
          <hr>
        </div>
      </div>
      <div class="col-12 my-3">
        <p>
          ...あなた達の旅はたった今から始まります。<br>
          まずは冒険者達が拠点とする街で、旅の支度をしましょう。
        </p>
      </div>
      <div class="col-12">
        <div class="next-page-form">
          <button class="btn btn-outline-info next-page-button" @click="switchMenuScreen">街へ向かう</button>
        </div>
      </div>
    </div>
  </div>
