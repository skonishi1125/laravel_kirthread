...
enum ItemData: int
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::ManaWater => '雫を集め多くAPを摂取できるように設計されたもの。仲間1人のAPを50pt回復。',
            ...
            self::DefenceGummy => '食べると一定時間DEFが20pt上昇するグミ。',
            self::DefenceMist => '周囲に振り撒くことで、しばらくの間味方全員のDEFが20pt上昇。',
            self::DefencePerfume => '護りの香水を振り撒き、しばらくの間味方全員のDEFが50pt上昇。',
            self::IntGummy => '食べると一定時間INTが20pt上昇するグミ。',
            self::IntMist => '周囲に振り撒くことで、しばらくの間味方全員のINTが20pt上昇。',
            self::IntPerfume => '知恵の香水を振り撒き、しばらくの間味方全員のINTが50pt上昇。',

            self::MiniBomb => '小さいが火力は充分。敵単体に物理属性のダメージを与える。',
