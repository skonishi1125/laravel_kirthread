...
enum EnemyData: int
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::ShadowWeed => '草木に擬態した影が本体の魔物。光が基本的に存在しない常夜の森ではその姿を捉えることは難しいが、ホシホタルだけは例外のため天敵。物理的な攻撃を得意とし、魔法への耐性が極めて高い。',
            self::Twilight => '常夜の森のヌシ。おっとりとした性格のようだが、豊富な魔法攻撃を使用して冒険者を苦しめる。巨大だがその姿は滅多に表さないらしく、かつては幸運の象徴だったとも言われている。',
