...
enum EnemyData: int
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::Norawani => '火山を彷徨く野良のワニ（おそらく）。バランスの良いステータスが特徴。',
            self::MagmaDile => 'ノラワニ達を仕切るボス。バランスの良いステータスを持つ。必ず戦闘前に咆哮を上げてステータスを高める。しばらくすると暴れ回るので、そのタイミングで防御を選択できると戦いやすいだろう。',
