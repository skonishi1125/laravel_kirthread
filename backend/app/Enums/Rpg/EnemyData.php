...
enum EnemyData: int
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::WitherNepenthos => '廃墟に棲み付いたネペントス。肥沃な土地ではないため枯れかけている。従来のネペントスと同じく消化液を吐いてくるが、飢え故に消化液は濃く強力。',
            self::PotDio => 'プランターに入ったディオネア。世話されていないため枯れかけている。人の手で植えられたものになると推測でき、英雄たちは魔物すら懐柔する力を持っていたことが分かる。',
