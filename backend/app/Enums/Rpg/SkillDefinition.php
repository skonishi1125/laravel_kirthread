...
enum SkillDefinition: int
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::HeavyKnuckle => '鎧をも砕く鋼鉄の拳を相手に撃ち込む。敵単体にDEFを無視した一撃を与える。',
            ...
            self::HeavenRay => '光の柱が広範囲に降り注ぎ、敵全体に魔法ダメージを与える。',
            ...
            self::DefendThreat => '脅威を感知し自動で保護する魔法。味方全員のDEFを暫くの間向上させる。',
            self::MagicEnt => '味方1人のINTを暫くの間向上させる。',
            self::ArcWisdom => '築き上げた叡智を仲間に分け与える呪文。味方全員のINTを暫くの間向上させる。',
