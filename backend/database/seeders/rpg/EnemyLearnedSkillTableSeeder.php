...
class EnemyLearnedSkillTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $seeds = [
            ...
            // オヤダマワニ
            ['enemy_id' => EnemyData::Oyadamawani, 'skill_id' => SkillDefinition::Bite, 'skill_level' => 1],
            ['enemy_id' => EnemyData::Oyadamawani, 'skill_id' => SkillDefinition::Rampage, 'skill_level' => 1],
            ['enemy_id' => EnemyData::Oyadamawani, 'skill_id' => SkillDefinition::Roar, 'skill_level' => 1],
