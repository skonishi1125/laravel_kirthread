    ...
    public function run(): void
    {
        ...
        $seeds = [
            ...
            [
                ...
                'name' => '固定行動をもつ魔物',
                'book_category' => Library::CATEGORY_ADVENTURE,
                'content' => '<p>体力が青く表示されている敵を見かけたことはないか？<br>そいつは特定の習性を持つ、「固定行動」を持った魔物だ。</p><p>代表的なのはワニ系統の敵だ。<br>必ず戦闘開始時に「咆哮」をあげて、自身のステータスを高めてくるんだ。<br>その間にボコっちまうかもしくは戦闘体制を整えるかはあんたの自由だ。</p><p>ワニ系統以外にも特定の習性を持つ魔物はたくさんいるから、<br>体力が青く表示される敵を見かけた時は<b>ターン数と行動</b>を気に留めておくといいぜ。</p>',
                'required_clears' => 2,
            ],
