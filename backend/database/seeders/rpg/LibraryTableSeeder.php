    ...
    public function run(): void
    {
        ...
        $seeds = [
            ...
            [
                ...
                'name' => 'スキルは基礎倍率だけじゃない',
                'book_category' => Library::CATEGORY_ADVENTURE,
                'content' => '<p>俺は自分で言うのもなんだが、スキル研究家だ。</p><p>それぞれの職業スキルには「基礎倍率」が設定されているものが殆どだ。<br>ただし、単に基礎倍率だけで効果全てが決まるわけじゃない。</p><p>実例として、基礎魔導「プチボルト(100%)」、中位魔導「エイルカリバー(150%)」を挙げてみようか。基礎倍率ってのは使い手のステータスが文字通り基礎値となるわけだ。使い手のINTが10(相当へっぽこな魔導師だが)、受け手のDEFとINTが0だった場合、「プチボルト」は10ダメージ, 「エイルカリバー」は15ダメージとなる。<p>...ただし、実際はそうじゃない。<br><b>驚くことに、「エイルカリバー」の方が30ほど大きいダメージが出るんだ。</b></p><p>つまり上位スキルは、ある程度のダメージが担保されているわけだ。<br>熟練することで習得可能になるスキルは基礎倍率だけでは測れない価値を持つものが多い。こればっかりは使ってみなければ分からないな。</p><p>街に癒しの館も出来たことだし、色々なスキルを覚えて試してみるのはどうだ？</p>',
                'required_clears' => 5,
            ],
            [
                'id' => 9,
