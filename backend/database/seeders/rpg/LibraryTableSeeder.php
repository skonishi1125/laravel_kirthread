    ...
    public function run(): void
    {
        ...
        $seeds = [
            ...
            [
                ...
                'content' => '<p>かつて、魔物が蔓延る大陸があった。<br>そこには噴煙を噴き上げる火山、凍てつく氷雪の荒野、陽光の届かぬ闇の領域が広がっていた。自然は苛烈にして、人の生を拒むかのようだった。<br>そんな大地に、ある日名もなき旅人たちが足を踏み入れた。</p><p>その瞬間こそ、この大陸の新たな伝承が幕を開けた時である。</p>',
                'required_clears' => 0,
            ],
            [
                'id' => 302,
                'name' => '大陸伝承II: 冒険',
                'book_category' => Library::CATEGORY_HISTORY,
                'content' => '<p>大陸には魔物の集落が点在している。<br>単独での踏破は不可能と悟った旅人は、三人一組の徒党を結成した。</p><p>武を振るう者、魔術を操る者、仲間を支える者。<br>彼らは小さな拠点を築き、その地を基に大陸を切り拓いていった。<br>草原を抜け、灼熱の火山を越え、やがて深き沼地をも踏み分ける。<br></p><p>そしてついに彼らの眼前に現れたのは、魔物の手で築かれた荘厳な石の城だった。</p>',
                'required_clears' => 1,
            ],
            [
                'id' => 303,
                'name' => '大陸伝承III: 繁栄',
                'book_category' => Library::CATEGORY_HISTORY,
                'content' => '<p>「ここが、大陸に蔓延る魔物の根城に違いない。」<br>旅人たちは城へ乗り込み、数多の魔物の群れへと立ち向かう。<br>激戦の果てに邪悪を退け、ついには城を支配する主をも討ち果たす。</p><p>その偉業は大陸中に響き渡り、人々は彼らを「英雄」として新たに崇め讃えた。</p><p>魔物の残党は退き、城の周囲には人が集い、富と秩序が築かれた。<br>かつて魔物の根城と恐れられた地周辺は、瞬く間に大陸随一の都へと変貌する。</p><p>こうして大陸は新たな時代を迎えた。</p>',
                'required_clears' => 3,
            ],
            [
                'id' => 304,
