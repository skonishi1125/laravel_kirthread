...
class LibraryTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 氷雪地帯
        $iceandsnow_preface = '<p>厳寒の大地に広がるとされる氷雪地帯は鍛え上げられた肉体を備え、<br>物理的な攻撃に対して耐性を示す個体が多いと言われている。<br>氷雪の怪物に挑む際は、環境対策と共に魔法攻撃の準備を怠らぬことが肝要である。白銀の静寂は美しくも、油断する者にとっては永遠の眠りを意味することとなる。</p><p>この地帯にはペンギン種の魔物が多く生息しており、<br>お腹を整える一定のしぐさをしたのちに突進してくる習性を持つ。</p><p>また、時折見かける妖精の放つ攻撃は非常に強力である。<br>打ち込まれる回数には限りがあるようなので、防御でやり過ごすことが有効か。</p>';
