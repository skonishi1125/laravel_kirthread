    ...
    public function run(): void
    {
        ...
        $seeds = [
            ...
            [
                ...
                'book_category' => Library::CATEGORY_ADVENTURE,
                'content' => '<p>初学者の方に向けて、戦闘の技術について優しく解説します。<br>今回は逃走時、全滅時の違いについてです。<br>あまり考えたいことではありませんが、もしもの時に役立ちますよ。</p><p></p><p>逃走した時は、「使ったアイテム」、「今まで獲得したEXPやレベル」が現時点の状態で街に戻ることになります。探索の中断と同じですね。<br>一方ですが全滅してしまった時は、「使ったアイテム」、「今まで獲得したEXPやレベル」が冒険前の状態に巻き戻った状態で街に戻ることになります。<br></p><p>全滅は大変なことのように見えますが、アイテムをたくさん使って結果的にフィールドの探索ができなかった時でも無駄にアイテムを消費してしまうことを防げますよ。</p><p>反省して、もう一度冒険にトライしてみましょう！</p>',
                'required_clears' => 0,
            ],
            [
                'id' => 4,
