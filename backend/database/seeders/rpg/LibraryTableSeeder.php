    ...
    public function run(): void
    {
        ...
        $seeds = [
            ...
            [
                ...
                'name' => '大陸伝承II: 冒険',
                'book_category' => Library::CATEGORY_HISTORY,
                'content' => '<p>大陸には恐ろしき魔物の集落が点在している。<br>単独での踏破は不可能と悟った旅人は、三人一組の徒党を結成した。</p><p>拳を振るう者、魔術を操る者、仲間を支える者。<br>彼らは小さな拠点を築き、その地を基に大陸を切り拓いていった。<br>草原を抜け、灼熱の火山を越え、やがて深き沼地をも踏み分ける。<br></p><p>そしてついに彼らの眼前に現れたのは、魔物の手で築かれた荘厳な石の城だった。</p>',
                'required_clears' => 1,
            ],
            [
                'id' => 303,
