...
class LibraryTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 砂漠
        $desert_preface = '<p>砂漠は、草原から先に広がる広大な乾燥地帯である。昼夜の寒暖差が激しく、地形は単調であるが、潜む魔物は決して侮れない個体が多い。<br>当地に棲息するのは、硬質の鱗を持つリザード類や堅牢な外殻を備えたスコーピオ種など、防御力に優れた個体が多いことで知られる。<br>物理的な攻撃はしばしば弾かれ、長期戦に持ち込まれやすいため、探索に臨む際には魔法攻撃を扱える術者を同行させるのが望ましい。<br>無策に挑めば、無尽の砂よりも先に魔物の甲殻に行く手を阻まれるだろう。</p>';
        ...
        // 火山
        $volcano_preface = '<p>活発な地殻活動によって形成された本地帯は、熱気と硫黄の噴煙に満ちている。<br>出没する魔物は物理防御力に長けた個体から、知性を持った存在まで多岐にわたり、物理・魔法の両面において脅威を備えている。<br>探索には攻防の均衡が取れたパーティを編成することが肝要である。</p>';
        ...
        // 海岸
        $coast_preface = '<p>この地域は、他の地帯に比して知性を帯びた魔物の割合が高いとされる。<br>彼らはしばしばマナを操り魔法攻撃を行使するため、不用意な接近は危険を伴う。<br>物理的な攻撃に対しては脆弱な傾向が見られるため、探索に赴く際には格闘家など、強力な物理攻撃を備えた者を同行させるのが望ましい。<br>油断すれば、穏やかな景観の下に潜む魔物の知略に飲み込まれてしまうだろう。</p>';
