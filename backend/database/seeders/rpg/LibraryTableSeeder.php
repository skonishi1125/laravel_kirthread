...
class LibraryTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 氷雪地帯
        $iceandsnow_preface = '<p>厳寒の大地に広がるとされる氷雪地帯は鍛え上げられた肉体を備え、<br>物理的な攻撃に対して耐性を示す個体が多いと言われている。<br>氷雪の怪物に挑む際は、環境対策と共に魔法攻撃の準備を怠らぬことが肝要である。</p><p>この地帯にはペンギン種の魔物が多く生息しており、<br>お腹を整える一定のしぐさをしたのちに突進してくる習性を持つ。</p><p>また、時折見かける青白い妖精の放つ全体攻撃は非常に強力である。打ち込まれる回数には限りがあるようなので、暫くの間防御でやり過ごすことが有効か。</p>';
        ...
        $seeds = [
            ...
            [
                ...
                'book_category' => Library::CATEGORY_ADVENTURE,
                'content' => '<p>砂漠地帯に棲息するサソリ型の魔物は、しばしば<b>致命の一撃</b>を放つことで知られている。<br>冒険者側の言葉で言うと、所謂<b>クリティカル</b>攻撃である。</p><p>致命の一撃は<b>DEFを完全に無視する特性</b>を持つ。ゆえに、重装備を誇る重騎士であっても油断すれば深手を負うことになる。また防御力を高める類の魔法スキル、この一撃の前では無力だ。耐久力に乏しい職種の者が直撃を受ければひとたまりもないだろう。</p><p>しかしながら、この力は敵のみが持つものではなく、冒険者の攻撃にもクリティカル攻撃が発生することがある。成功すれば魔物の防御を貫き、深々と刃を突き立てることができるだろう。</p><p>狙って放つことは難しいが、運命が味方する瞬間にこそ戦況を覆す一撃が生まれる。その一閃に賭けてみるのも、また冒険者の醍醐味である。</p>',
                'required_clears' => 1,
            ],
            [
                'id' => 6,
            ...
            [
                ...
                'book_category' => Library::CATEGORY_ADVENTURE,
                'content' => '<p>月刊トリップだ。</p><p>近頃、とある冒険者たちが大陸の開拓をどんどん進めているらしい。<br>そのおかげで採取できる素材も増えて、ショップの品数も潤沢になってきたな。<br>今回は月刊トリップ直伝、これだけは買っとけって商品を紹介するぜ。</p><p>まずは「<b>オールポーション</b>」だ。<br>まあとにかく、やばい！って時にとりあえず使えるアイテムだな。</p><p>次は「<b>マナウォーター</b>」だ。<br>強敵との戦闘でAPが枯渇して引き返したことはないか？<br>これ1本持っておくだけでグッと機会が減るぜ。財布には優しくないけどな。</p><p>最後は、最近入荷された「<b>リザレクトエレメント</b>」だ。<br>戦闘不能の味方に使うと気力を取り戻す、絶対に持っといた方がいい一品だな。<br>あるだけで安定感爆上がりだ。</p><p>どれも便利すぎて、毎回買いすぎちまうぜ。<br>あーあー、また日雇いギルドでバイトしなきゃな。あそこキツいんだよな...。</p>',
                'required_clears' => 5,
            ],
            [
                'id' => 9,
                'name' => 'スキルは基礎倍率だけじゃない',
                'book_category' => Library::CATEGORY_ADVENTURE,
                'content' => '<p>俺は自分で言うのもなんだが、スキル研究家だ。</p><p>それぞれの職業スキルには「基礎倍率」が設定されているものが殆どだ。<br>ただし、単にこれだけでスキルの効果全てが決まるわけじゃない。</p><p>実例として、基礎魔導「プチボルト(100%)」、中位魔導「エイルカリバー(150%)」を挙げてみようか。基礎倍率ってのは使い手のステータスが文字通り基礎値となるわけだ。使い手のINTが10(相当へっぽこな魔導師だが)、受け手のDEFとINTが0だった場合、「プチボルト」は10ダメージ, 「エイルカリバー」は15ダメージとなる。<p>...ただし、実際はそうじゃない。<br><b>驚くことに、「エイルカリバー」の方が30ほど大きいダメージが出るんだ。</b></p><p>つまり上位スキルは、ある程度のダメージが担保されているわけだ。<br>熟練することで習得可能になるスキルは基礎倍率だけでは測れない価値を持つものが多い。こればっかりは使ってみなければ分からないな。</p><p>街に癒しの館も出来たことだし、色々なスキルを覚えて試してみるのはどうだ？</p>',
                'required_clears' => 5,
            ],
            [
                'id' => 10,
