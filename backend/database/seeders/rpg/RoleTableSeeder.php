    ...
    public function run(): void
    {
        ...
        $roles = [
            [
                ...
                'description' => '高い物理攻撃力と素早さを誇る、高速アタッカーです。',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'cutscene_image_path' => 'cutscene.png',
                'description' => '味方を癒す回復のスペシャリストです。習熟させれば魔法攻撃もこなせます。',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'cutscene_image_path' => 'cutscene.png',
                'description' => '最も打たれ強く、仲間たちを護る能力を持ちます。',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'cutscene_image_path' => 'cutscene.png',
                'description' => 'APを使用した、高威力の魔法攻撃で相手を殲滅します。',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'cutscene_image_path' => 'cutscene.png',
                'description' => '攻撃と回復どちらもこなす、パーティの補完的職業です。',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'cutscene_image_path' => 'cutscene.png',
                'description' => '味方のステータスを高める力を持つ大器晩成のサポーターです。',
                'created_at' => $now,
                'updated_at' => $now,
            ],
        ];
